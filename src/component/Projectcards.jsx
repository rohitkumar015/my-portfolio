  ...
  return (
    <div>
      <motion.div
        ...
        className="project_card mb-3"
      >
        <div className="row  overflow-hidden">
          <div className="col-lg-6 col-md-6 col-12">
            <h4
              className="secondary_text_clr mt-2"
              style={{ textAlign: "left" }}
            >
              NetFlixGpt
            </h4>
            <p
              className="secondary_text_clr mt-3"
              style={{ textAlign: "left" }}
            >
              "NetflixGPT" is a project I built as a practice exercise in React
              for beginners. It incorporates several key technologies such as
              Redux for state management and React Router for navigation.
            </p>
            <div style={{ textAlign: "left" }}>
              <a
                href="https://moviesnetflix.netlify.app/"
                target="blank"
                style={{ textAlign: "left" }}
        ...
        <div className="row  overflow-hidden">
          <div className="col-lg-6 col-md-6 col-12">
            ...
            <p
              ...
              style={{ textAlign: "left" }}
            >
              I designed a website that can run and make the admission process
              easier a lot more effective and less time-consuming. The hassle of
              standing in a queue, submitting documents online, and booking the
              seat for the candidate would be erased.{" "}
            </p>
            {/* <div  style={{ textAlign: "left" }} >
