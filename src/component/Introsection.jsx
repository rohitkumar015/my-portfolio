          ...
          <div>
            <div className="intro_section">
              ...
              <div className="d-flex justify-content-center flex-m-column mt-5  align-items-center gap-3 my-3">
                <button className="my_primary_btn btn"><a href="tel:8652664872">Contact me here <IoIosArrowRoundForward className="" style={{width:'25px',fontSize:'25px' }}></IoIosArrowRoundForward><i className=""></i></a></button>
                ...
                <Link to='https://www.linkedin.com/in/rohitkumar1255'><span className="social_links"><FaLinkedin></FaLinkedin></span></Link>
               <Link to='https://github.com/rohitkumar015'> <span className="social_links"><FaGithub></FaGithub></span></Link>
              </div>
            </div>
          </div>
        </div>
